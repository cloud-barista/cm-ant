...
// -------------------------------------------------------
    ...
    document.getElementById('execute-test').addEventListener('click', function () {
        ...
        const remoteConnectionType = document.getElementById('remote-connection-type').value;
        const username = remoteConnectionType !== 'builtIn'
            ? document.getElementById('username').value
            : document.getElementById('username-built-in').value;
        const publicId = document.getElementById('public-id').value;
        const cert = document.getElementById('cert').value;
        const nsId = document.getElementById('ns-id').value;
        const mcisId = document.getElementById('mcis-id').value;

        const virtualUsers = document.getElementById('virtual-users').value;
        const duration = document.getElementById('duration').value;
        const rampUpTime = document.getElementById('ramp-up-time').value;
        const rampUpSteps = document.getElementById('ramp-up-steps').value;


        const httpReqs = Array.from(document.querySelectorAll('.load-execution-http-req')).map(req => {
            return {
